...
class FrostNova : public AbilityObjekt
{
public:
	FrostNova(bool Diraction_Right, float Owners_Position_x, float Owners_Position_y, Faction faction, int NumberOfIceCubes);
	~FrostNova(void);
...
private:
	...
	int m_Manacost;
	bool m_isAlive;
	int m_NumberOfIceCubes;
	bool m_HasCreateFrostNova;
};
